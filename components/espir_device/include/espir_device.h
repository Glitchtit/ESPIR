...
typedef struct {
    ...
    bool         ota;             /* register the Zigbee OTA Upgrade client cluster (set per app) */
    uint16_t     ota_image_type;  /* ESPIR_OTA_IMAGE_TYPE_* advertised by the OTA cluster (when ota) */
